...
var file_service_service_proto_depIdxs = []int32{
	...
	0, // 1: service.HelloWorldService.HelloWord:input_type -> service.HelloWorldRequest
	1, // 2: service.HelloWorldService.HelloWord:output_type -> service.HelloWorldResponse
