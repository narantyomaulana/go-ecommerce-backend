...
const file_service_service_proto_rawDesc = "" +
	...
	"\x11HelloWorldService\x12D\n" +
	"\tHelloWord\x12\x1a.service.HelloWorldRequest\x1a\x1b.service.HelloWorldResponseB=Z;github.com/narantyomaulana/go-grpc-ercommerce-be/pb/serviceb\x06proto3"
...
var file_service_service_proto_depIdxs = []int32{
	0, // 0: service.HelloWorldService.HelloWord:input_type -> service.HelloWorldRequest
	1, // 1: service.HelloWorldService.HelloWord:output_type -> service.HelloWorldResponse
