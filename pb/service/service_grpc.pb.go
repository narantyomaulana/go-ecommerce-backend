...
const (
	HelloWorldService_HelloWord_FullMethodName = "/service.HelloWorldService/HelloWord"
)
...
type HelloWorldServiceClient interface {
	HelloWord(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error)
}
...
func (c *helloWorldServiceClient) HelloWord(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, HelloWorldService_HelloWord_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServiceServer interface {
	HelloWord(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error)
...
func (UnimplementedHelloWorldServiceServer) HelloWord(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorldService_HelloWord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloWorldRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServiceServer).HelloWord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorldService_HelloWord_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).HelloWord(ctx, req.(*HelloWorldRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HelloWorldService_HelloWord_Handler,
		},
	},
